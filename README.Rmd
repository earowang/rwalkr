...
[![Travis-CI Build Status](https://travis-ci.org/earowang/walkrr.svg?branch=master)](https://travis-ci.org/earowang/walkrr)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/walkrr)](https://cran.r-project.org/package=walkrr)
